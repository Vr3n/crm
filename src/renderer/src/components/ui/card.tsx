...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        'flex flex-col gap-(--card-spacing) rounded-xl border bg-card py-(--card-spacing) text-card-foreground shadow-sm [--card-spacing:--spacing(4)] data-[size=sm]:[--card-spacing:--spacing(3)]',
        className
      )}
      {...props}
    />
