-- Grants the lead.delete permission to the Manager and Sales starter roles for
...
INSERT OR IGNORE INTO `permissions` (`code`, `description`) VALUES ('lead.delete', NULL);--> statement-breakpoint
