...
urlpatterns = [
    ...
    path('<uuid:pk>/', views.client_detail_view, name="client-detail"),
    ...
    path('hx/delete/<uuid:pk>/', views.hx_delete_client_view,
         name="hx-delete-client"),

    # HX Mobile views.
    path('hx/mobile-numbers/table/<uuid:client_id>/',
    ...
    path('hx/mobile-numners/table/delete/<uuid:pk>',
         views.hx_client_mobile_delete,
         name="hx-clients-mobile-table-delete"),

    # HX Email views.
    path('hx/email-addresses/table/<uuid:client_id>/',
    ...
    path('hx/email-addresses/table/delete/<uuid:pk>/',
