...
urlpatterns = [
    ...
    path('hx/<int:pk>/delete/', views.hx_lead_delete_view,
         name="hx-delete-lead"),
    path('hx/all-leads/table/', views.hx_leads_table, name="hx-leads-table"),

    # HX Mobile views.
    path('hx/mobile-numbers/table/<int:lead_id>/', views.hx_lead_mobile_table,
    ...
    path('hx/mobile-numners/table/delete/<int:pk>', views.hx_lead_mobile_delete,
         name="hx-leads-mobile-table-delete"),

    # HX Email views.
    path('hx/email-addresses/table/<int:lead_id>/', views.hx_lead_email_table,
    ...
    path('hx/email-addresses/table/delete/<int:pk>/', views.hx_lead_email_delete,
